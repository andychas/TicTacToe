...
{
    public partial class ChampForPlayerForm : Form, IServiceCallback
    {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            label1.Text = "All championships for " + player.First_Name + " " + player.Last_Name;
            Championship[] championships = c.GetChampionshipsByPlayerId(player);
